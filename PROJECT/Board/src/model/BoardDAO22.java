...
public class BoardDAO22 {
	...
	// getAllBoard(startRow,pageSize)
	public ArrayList<BoardBean> getAllBoard(int startRow,int pageSize){
		...
		try {
			String sql = "select * from board order by ref desc, re_level asc limit ?,?";
			pstmt = con.prepareStatement(sql);
