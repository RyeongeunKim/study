	...
	<div class="container">
		...
		<form method="post" action="updateAction.jsp?bbsID=<%= bbsID %>">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="글 제목" name="bbsTitle" maxlength="50" value="<%= bbs.getBbsTitle() %>" required="required"></td>
					</tr>
					<tr>
						<td><input type="file" class="form-control" placeholder="파일" name="filename"></td>
					</tr>
					<tr>	
						<td><textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048" style="height: 350px;" required="required"><%= bbs.getBbsContent() %></textarea></td>
					</tr>
				</tbody>
			</table>
