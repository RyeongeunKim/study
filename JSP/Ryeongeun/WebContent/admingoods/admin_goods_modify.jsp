	...
	<form action="./AdminGoodsModifyAction.ag" method="post">
		...
		<table border="1">
			...
			<tbody>
				...
				<tr>
		           <td>성분</td>
		           <td><textarea name="ingredient" value="<%=dto.getIngredient() %>"></textarea></td>           
		        </tr> 
				<tr>
		           <td>사용방법</td>
		           <td><textarea name="cosMethod" value="<%=dto.getCosMethod() %>"></textarea></td>           
		        </tr>
				<tr>
		           <td>주의사항</td>
		           <td><textarea name="cosWarning" value="<%=dto.getCosWarning() %>"></textarea></td>           
		        </tr>
