...
/*****************************************************************************************/
//제시된 클래스이름 으로 만들기  
//-> SimpleMath1클래스, AreaMath1클래스, PerimeterMath1클래스 ,HowMethod2클래스 는 main메소드가 있음
/*****************************************************************************************/
...
class PerimeterMath1 { // 직사각형의 둘레계산클래스
	...
	public static double calRectanglePeri(double width, double height) {
		...
		return SimpleMath1.add(SimpleMath1.mul(width, 2), SimpleMath1.mul(height, 2)); // 직사각형 둘레 리턴
...
/*
	결론 :
	-> static 메소드를 선언하면 원넓이 계산 클래스나 둘레 계산 클래스 내부에서
